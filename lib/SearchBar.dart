  ...
  Widget _buildSliverAppbar(){
    return SliverAppBar(
      ...
      flexibleSpace: FlexibleSpaceBar(
        title: Text("搜索栏" , style: _titleFont,),
        centerTitle: false,
          ...
          <Widget>[
            new TextField(
              decoration: InputDecoration(
                ...
                labelText: "Search",
                hasFloatingPlaceholder:false,//提示文字不浮动
                labelStyle: TextStyle(
                  color: Colors.black38,
                ),
                prefixIcon: new Icon(Icons.search , color: Colors.grey,),
                contentPadding: const EdgeInsets.symmetric(vertical: 10.0),//设置框的高度
              ),
              onTap: (){
