...
class _DataTablePageState extends State<DataTablePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('数据表' , style: TextStyle(fontSize: 17.0)),
      ),
...
class MyTable extends DataTableSource {
  List<Shop> _shops = <Shop>[
    Shop('小米6x', 100, '手机', 1699),
    Shop('华为P30', 50, '手机', 4990),
    Shop('华硕a61', 50, '电脑', 5700),
    Shop('OPPO Reno2', 100, '手机', 5000),
    Shop('iPhone8 Plus', 500, '手机', 5000),
    Shop('iphone7plus耳机', 9999, '耳机', 60),
    Shop('iphone7plus256g', 10, '手机', 4760),
    Shop('金士顿8g内存条', 66, '内存条', 399),
    Shop('西门子洗衣机9.0kg', 890, '家电', 10399),
    Shop('三星66寸液晶智能电视', 800, '家电', 20389),
  ];
